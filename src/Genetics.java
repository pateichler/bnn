...
public class Genetics implements Serializable {
  ...
  public Genetics() {
    ...
    typeLayers[strengthLayers.length - 1] = Settings.Instance.totalNTCount();
  ...
  public Genetics(Genetics parent1, Genetics parent2) throws Exception {
    this(parent1, parent2, 0.5);
  }
  
  public Genetics(Genetics parent1, Genetics parent2, double parent1Ratio) throws Exception {
